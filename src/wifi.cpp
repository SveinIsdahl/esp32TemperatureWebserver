                ...
                if (client.available()) {  // if there's bytes to read from the
                    ...
                    if (c == '\n') {  // if the byte is a newline character
                        ...
                        if (currentLine.length() == 0) {
                            ...
                            text-align: center;}"); client.println(".button {
                            background-color: #4CAF50; border: none; color:
